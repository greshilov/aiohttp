...
@pytest.mark.parametrize(
    ...
    [
        ...
        # http -> https (note: behaviour will change since 4.0)
        [
            "http://host1.com/path1",
            "https://host1.com/path1",
        ],
        # https -> http
...
async def test_drop_auth_on_redirect_to_other_host(
    aiohttp_server, tls_certificate_authority, url_a, url_b
) -> None:
    yarl_a = URL(url_a)
    yarl_b = URL(url_b)
    ...
    async def create_server(url, srv):
        app = web.Application()
